    ...
    <StafLayout>
        ...
        <div class="min-h-screen px-4 py-3 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-7xl">
                ...
                <CustomTable :headers="headers" :pagination="customers">
                    <tr v-for="cust in customers.data" :key="cust.id_customer" class="transition-colors hover:bg-base-200/50">
                        ...
                        <td class="px-6 py-4 text-center">
                            <CustomTableAction v-slot="{ close }">
                                ...
                                <Link v-if="$can('customer')" :href="route('customer.rekap', cust.id_customer)" @click="close" class="flex items-center px-4 py-2.5 text-sm font-bold text-success hover:bg-success/10 transition-colors">
