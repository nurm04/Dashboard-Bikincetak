        ...
        <template #header>
            <div class="flex flex-col items-start justify-between w-full gap-4 md:flex-row md:items-center">
                <div>
                    ...
                    <p class="text-xs font-bold opacity-60 mt-0.5">Ringkasan operasional dan keuangan harian</p>
                </div>

                <CustomButton type="link" :href="route('pesan.pos-kasir')" variant="primary" size="md" class="w-full transition-transform duration-300 md:w-auto hover:-translate-y-1">
                                    ...
                                    <table class="table w-full table-xs">
                                        <tbody>
                                            ...
                                            <tr v-for="psn in urgentProduksi" :key="psn.id_pesan" class="hover text-[11px]">
                                                ...
                                                <td class="text-right">
                                                    <span class="text-[9px] bg-warning/20 text-warning px-2 py-0.5 rounded font-bold uppercase">Sedang Dikerjakan</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
