...
class ProdukSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('varian')->insert([
            ['id_varian' => 'VAR-001', 'nama_varian' => 'Bahan Kertas', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_varian' => 'VAR-007', 'nama_varian' => 'Bahan Kalender', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_varian' => 'VAR-027', 'nama_varian' => 'Bahan Map', 'created_at' => $now, 'updated_at' => $now],
            ['id_varian' => 'VAR-028', 'nama_varian' => 'Pulpen Ballpoint', 'created_at' => $now, 'updated_at' => $now],
            ['id_varian' => 'VAR-029', 'nama_varian' => 'Nama Data', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_varian' => 'VAR-032', 'nama_varian' => 'Mouse Pad', 'created_at' => $now, 'updated_at' => $now],
        ...
        DB::table('pilihan_varian')->insert([
            ...
            ['id_pilihan' => 'VAR-001-007', 'id_varian' => 'VAR-001', 'nama_pilihan' => 'Art Carton 210gr', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-001-008', 'id_varian' => 'VAR-001', 'nama_pilihan' => 'Art Carton 260gr', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-001-009', 'id_varian' => 'VAR-001', 'nama_pilihan' => 'Art Carton 310gr', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-001-010', 'id_varian' => 'VAR-001', 'nama_pilihan' => 'Art Paper 120gr', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-001-011', 'id_varian' => 'VAR-001', 'nama_pilihan' => 'Art Paper 150gr', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-001-012', 'id_varian' => 'VAR-001', 'nama_pilihan' => 'Photopaper 210', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-001-013', 'id_varian' => 'VAR-001', 'nama_pilihan' => 'Photopaper 230', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pilihan' => 'VAR-001-017', 'id_varian' => 'VAR-001', 'nama_pilihan' => 'Jasmin', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pilihan' => 'VAR-002-007', 'id_varian' => 'VAR-002', 'nama_pilihan' => 'Sepertiga A4', 'created_at' => $now, 'updated_at' => $now],

            ['id_pilihan' => 'VAR-003-001', 'id_varian' => 'VAR-003', 'nama_pilihan' => 'Chromo', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-003-002', 'id_varian' => 'VAR-003', 'nama_pilihan' => 'Vinyl', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-003-003', 'id_varian' => 'VAR-003', 'nama_pilihan' => 'Vinyl Putih', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-003-004', 'id_varian' => 'VAR-003', 'nama_pilihan' => 'Vinyl Silver', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-003-005', 'id_varian' => 'VAR-003', 'nama_pilihan' => 'Vinyl Transparan', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-003-006', 'id_varian' => 'VAR-003', 'nama_pilihan' => 'HVS', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pilihan' => 'VAR-007-001', 'id_varian' => 'VAR-007', 'nama_pilihan' => 'AC210', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-007-002', 'id_varian' => 'VAR-007', 'nama_pilihan' => 'AC260', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pilihan' => 'VAR-025-001', 'id_varian' => 'VAR-025', 'nama_pilihan' => 'Stopper tali lanyard', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pilihan' => 'VAR-027-001', 'id_varian' => 'VAR-027', 'nama_pilihan' => 'Map', 'created_at' => $now, 'updated_at' => $now],

            ['id_pilihan' => 'VAR-028-001', 'id_varian' => 'VAR-028', 'nama_pilihan' => 'Pulpen Bolpoin', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-028-001', 'id_varian' => 'VAR-028', 'nama_pilihan' => 'Pulpen Bolpoin UV Custom - 1 Sisi', 'created_at' => $now, 'updated_at' => $now],

            ['id_pilihan' => 'VAR-029-001', 'id_varian' => 'VAR-029', 'nama_pilihan' => 'Nama Dada Cemiti Gravoply', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_pilihan' => 'VAR-032-001', 'id_varian' => 'VAR-032', 'nama_pilihan' => 'Mouse Pad', 'created_at' => $now, 'updated_at' => $now],

            ['id_pilihan' => 'VAR-033-001', 'id_varian' => 'VAR-033', 'nama_pilihan' => '8x6cm', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-033-002', 'id_varian' => 'VAR-033', 'nama_pilihan' => '15x6cm', 'created_at' => $now, 'updated_at' => $now],

            ['id_pilihan' => 'VAR-034-001', 'id_varian' => 'VAR-034', 'nama_pilihan' => '30x46cm', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-034-002', 'id_varian' => 'VAR-034', 'nama_pilihan' => '36x50cm', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-034-003', 'id_varian' => 'VAR-034', 'nama_pilihan' => '40x60cm', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-034-004', 'id_varian' => 'VAR-034', 'nama_pilihan' => '50x73cm', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-034-005', 'id_varian' => 'VAR-034', 'nama_pilihan' => '73x100cm', 'created_at' => $now, 'updated_at' => $now],

            ['id_pilihan' => 'VAR-035-001', 'id_varian' => 'VAR-035', 'nama_pilihan' => 'Hitam', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-035-002', 'id_varian' => 'VAR-035', 'nama_pilihan' => 'Putih', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-035-003', 'id_varian' => 'VAR-035', 'nama_pilihan' => 'Abu Grey', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-035-004', 'id_varian' => 'VAR-035', 'nama_pilihan' => 'Merah', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-035-005', 'id_varian' => 'VAR-035', 'nama_pilihan' => 'Pink', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-035-006', 'id_varian' => 'VAR-035', 'nama_pilihan' => 'Hijau Army', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-035-007', 'id_varian' => 'VAR-035', 'nama_pilihan' => 'Navy', 'created_at' => $now, 'updated_at' => $now],
            ['id_pilihan' => 'VAR-035-008', 'id_varian' => 'VAR-035', 'nama_pilihan' => 'Biru Muda', 'created_at' => $now, 'updated_at' => $now],
        ...
        DB::table('produk')->insert([
            ['id_produk' => 'PRD-0001', 'id_kategori' => 'KAT-001', 'nama_produk' => 'Custom', 'gambar' => null, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id_produk' => 'PRD-0002', 'id_kategori' => 'KAT-001', 'nama_produk' => 'Jasa Desain', 'gambar' => null, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_produk' => 'PRD-5010', 'id_kategori' => 'KAT-005', 'nama_produk' => 'Mouse Pad', 'gambar' => null, 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        ...
        DB::table('produk_varian')->insert([
            ...
            ['id_produk' => 'PRD-5006', 'id_varian' => 'VAR-027', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_produk' => 'PRD-5010', 'id_varian' => 'VAR-032', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id_produk' => 'PRD-8011', 'id_varian' => 'VAR-002', 'created_at' => $now, 'updated_at' => $now],
